...
namespace Oculus.Interaction
{
        ...
        TouchHandGrabInteractor : PointerInteractor<TouchHandGrabInteractor, TouchHandGrabInteractable>
    {
        ...
        //Two Methods Overridden to resolve conflict between touch hand grad and normal hand grab
        protected override void HandleDisabled()
        {
            print("Touch hand disabled");
            base.HandleDisabled();
            this.GetComponent<TouchHandGrabInteractorVisual>().enabled = false;
        }
        protected override void HandleEnabled()
        {
            print("Touch hand enabled");
            base.HandleDisabled();
            this.GetComponent<TouchHandGrabInteractorVisual>().enabled = true;
        }
    }
}
